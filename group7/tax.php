...
<div id="mainPage">
    ...
    <div class="content-container">
        <div class="content" id="mainContent">
            ...
            <h1>Manage Community Tax</h1>
            <p style="font-size: 15px;"></p>
            </div>

          <main>
            <div class="box">
                <h3 class="color">View Community Tax</h3><div class="hr"></div>
                <p>See the list of all community tax records.</p><br>
                <a href="view_community_tax.php">Community Tax List</a>
            </div>
            
            <div class="box">
                <h3 class="color">Add Community Tax</h3><div class="hr"></div>
                <p>Add a new community tax record for a resident.</p><br>
                <a href="add_community_tax.php" style="">Create Community Tax</a>
            </div>
