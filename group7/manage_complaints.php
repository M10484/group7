...
<div id="mainPage">
    ...
    <div class="content-container">
        <div class="content" id="mainContent">
            ...
            <h1>Manage Complaints/Requests</h1>
            <p style="font-size: 15px;"></p>
            </div>

          <main>
            <div class="box">
                <h3 class="color">Manage Complaints</h3><div class="hr"></div>
                <p>View and manage all complaints.</p>
                <a href="complaints.php">Go to Complaints</a>
            </div>
            
            <div class="box">
                <h3 class="color">Manage Clearances</h3><div class="hr"></div>
                <p>View and manage clearances.</p>
                <a href="clearance.php">Go to Clearances</a>
            </div>

            <div class="box">
                <h3 class="color">Manage Certificates</h3><div class="hr"></div>
                <p>View and manage certificates</p>
                <a href="certificates.php">Go to Certificates</a>
            </div>

            <div class="box">
                <h4 class="color">Manage Community Tax</h4><div class="hr"></div>
                <p>View and manage community tax records.</p>
                <a href="tax.php">Go to Community Tax</a>
            </div>
          </main>
