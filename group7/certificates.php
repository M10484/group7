...
<div id="mainPage">
    ...
    <div class="content-container">
        <div class="content" id="mainContent">
          ...
          <main>
            <div class="box">
                <h3 class="color">View Certifacates</h3><div class="hr"></div>
                <p>See the list of all issued ciirtificates.</p>
                <a href="view_certificates.php">Go to Certificates List</a>
            </div>
            
            <div class="box">
                <h3 class="color">Add Certifacates</h3><div class="hr"></div>
                <p>Add a new certificate for resident.</p>
                <a href="add_certificate.php">Create Certificatte</a>
            </div>
