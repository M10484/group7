    ...
    <div class="content-container">
        <div class="content" id="mainContent">
           ...
           padding-top: 30px;
            ...
            ">
            <div class="sqaure">
            <i class="fa-solid fa-eye" style="padding-top: 48px;"></i><br>View Resident
            <br> <button><a href="viewr.php">View</a></button>
            </div>

            <div class="sqaure">
            <i class="fa-solid fa-user-group" style="padding-top: 48px;"></i><br>Add New Resident
            <br> <button><a href="create_resident.php">Add</a></button>
            </div>
