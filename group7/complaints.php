...
<div id="mainPage">
    ...
    <div class="content-container">
        <div class="content" id="mainContent">
          ...
          <main>
            <div class="box">
                <h3 class="color">View Complaints</h3><div class="hr"></div>
                <p>See the list of all registered complaints.</p>
                <a href="view_complaints.php">Go to Complaints List</a>
            </div>
            
            <div class="box">
                <h3 class="color">Add New Clearances</h3><div class="hr"></div>
                <p>File a new complaints.</p><br>
                <a href="add_complaints.php">Create complaint</a>
            </div>
